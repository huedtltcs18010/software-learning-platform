<div class="p-3">
    ...
    <div class="form-group row search-series-wrapper">
        ...
        <div class="col-sm-10">
            @if ($series)
                {{ Form::select('series_id', $series, null, ['class' => 'form-control', 'style' => 'margin-bottom: 3px;']) }}
            @endif
            <input name="series" type="text" class="form-control txt-keyword" placeholder="New series? Enter name here!" value="{{ isset($seriesName) ? $seriesName : '' }}">
